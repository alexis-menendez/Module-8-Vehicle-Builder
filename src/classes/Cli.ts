  ...
  findVehicleToTow(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        // Prevent a truck from towing itself
        ...
        console.log(`${selectedVehicle.make} ${selectedVehicle.model} is now being towed!`);
        this.performActions();
      });
  }
  ...
  performActions(): void {
    inquirer
      .prompt([
        {
          ...
          choices: [
            ...
            'Turn left',
            'Reverse',
            this.isTruck() ? 'Tow a vehicle' : null,
            this.isMotorbike() ? 'Perform wheelie' : null,
      ...
      .then((answers) => {
        ...
        else if (answers.action === 'Tow a vehicle' && this.isTruck()) {
          this.findVehicleToTow();
          return; 
        }
        else if (answers.action === 'Perform wheelie' && this.isMotorbike()) {
          for (let i = 0; i < this.vehicles.length; i++) {
